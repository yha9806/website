...
• L1-L5 framework: Visual Perception → Philosophical Aesthetics
• Already tested on 42+ models including GPT-4V, Gemini, Claude, Qwen-VL
...
• Expert-annotated bilingual critiques (7,410 pairs)
• Tested on 42+ frontier models
• Framework spans perception to philosophical aesthetics (L1-L5)
...
## 邮件 3: Prof. Danqi Chen - Princeton NLP
...
• 47 dimensions across 8 cultural traditions (Chinese, Western, Japanese, etc.)
• 7,410 matched image-critique pairs with expert annotations
...
• Symbolic interpretation (religious, cultural, historical symbols)
• Cross-cultural context understanding
• Aesthetic judgment and critique generation
• Cultural bias detection across 8 traditions
...
## 邮件 6: Berkman Klein Center - Harvard
...
• Consistent Western bias across major VLMs
• Performance gaps of 15-25% between Western and non-Western cultural content
• Higher-layer cultural reasoning (philosophical, aesthetic) is significantly harder than visual perception
...
• Addresses cultural bias in multimodal AI (a growing research priority)
• Provides measurable metrics for responsible AI development
• Bridges AI research with digital humanities
...
## 邮件 8: Metropolitan Museum - Open Access
...
What we offer:
• Evaluation of AI interpretation accuracy across cultural traditions
• Benchmark testing on 42+ vision-language models
• Insights into which AI tools best preserve cultural nuance
...
## 邮件 10: Advance AI Safety Today (ai-evaluation.org)
...
• We evaluate how well AI understands cultural context in art
• 47 dimensions, 8 cultural traditions, 42+ models tested
• Results show consistent Western bias across all major VLMs
