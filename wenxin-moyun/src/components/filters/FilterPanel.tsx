  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-[#1A1614] border border-gray-300 dark:border-gray-600 rounded-lg hover:shadow-md transition-all"
      >
      ...
      >
        <div className="absolute top-full mt-2 left-0 right-0 md:left-auto md:right-auto md:w-96 bg-white dark:bg-[#1A1614] rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 z-50 p-6">
          {/* Header */}
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="输入模型名称..."
                className="w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-[#0F0D0C] text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-slate-500 focus:border-transparent"
              />
            </div>
          </div>
          ...
          <div className="mb-4">
            ...
            <select
              ...
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-[#0F0D0C] text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-slate-500"
            >
