-- Insert-only SQL script for comprehensive_v2.json data
-- No deletion - just insert new benchmark data

-- Insert new models (top 15 with scores > 0)
...
ON CONFLICT (name, organization) DO UPDATE SET
    ...
    score_weaknesses = EXCLUDED.score_weaknesses,
